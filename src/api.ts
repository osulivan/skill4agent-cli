  ...
  try {
    ...
    return {
      skill: {
        ...
        tags: skill.tags,
        tagsCn: skill.tagsCn,
        originalLanguage: skill.translation?.original_language,
        hasTranslation: skill.translation?.has_translation,
        hasScript: skill.script?.has_script,
        scriptCount: skill.script?.script_count || skill.scriptCount || 0,
        scriptCheckResult: skill.script?.script_check_result,
